...
2. Describe output
''''
Our ouptut should have separate files for each matched index read, a file for reads that underwent index hopping for each read, and a file for unknown indexes for each read. 
